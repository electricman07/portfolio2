    ...
    <header className="sticky top-0 z-50 border-b border-(--bg-primary) bg-(--bg-primary) px-4 backdrop-blur-lg">
      <nav className="page-wrap flex flex-wrap items-center gap-x-3 gap-y-2 py-3 sm:py-4">
        <h2 className="m-0 shrink-0 text-base font-semibold tracking-tight">
          <Link
            to="/"
            className="inline-flex items-center gap-2 rounded-full border border-(--accent-secondary) bg-(--accent-secondary) px-3 py-1.5 text-sm text-(--text-primary) no-underline shadow-[0_8px_24px_rgba(30,90,72,0.08)] sm:px-4 sm:py-2"
          >
            <img src="/images/Avatar50.png" alt="logo" className="w-6 h-6" />
            Glen Popowich
          </Link>
        </h2>
